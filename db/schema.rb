...
ActiveRecord::Schema[7.1].define(version: 20_250_306_080_238) do
  ...
  create_table 'read_marks', force: :cascade do |t|
    ...
    t.index %w[reader_id reader_type readable_type readable_id], name: 'read_marks_reader_readable_index',
                                                                 unique: true
